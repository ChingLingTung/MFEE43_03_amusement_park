  ...
  return (
    <>
      <div className={styles.container}>
        ...
        <div className={styles.card_flex} style={{paddingLeft:250,paddingRight:250}}>
          <div>
      ...
      <div className={styles.container}>
        <div className={styles.theme_img}><Image className={styles.theme_img} src={'/../../images/w1.jpg'} resizeMode={'cover'} style={{width:'100%',height:200}} /></div>
      </div>
