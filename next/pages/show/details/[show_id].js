          ...
          <div className={styles.contain}>
            <div style={{ width: 1200 }}>
              <img
                ...
                width="100%"
                height={300}
                src={`/images/show/${getData.show_pic}`}
              />
              ...
              <div style={{ lineHeight: 2 }}>
                ...
                <p>
                  演出時間：{getData.start} 至 {getData.finish}
                </p>
              ...
              {!toggle ? (
                ...
                <>
                  <div
                    style={{ marginLeft: 105, marginTop: 50 }}
                    className={styles.seat_center}
                  >
                    <div>
                      {seat.map((row, i) => (
                        <div key={i}>
